...
export default function Targets({data}) {
  ...
  async function handleSave(type){
    ...
    // Error occurs here when calls function to update targets

    
    // await updateTargets("energy", energy, type, organisationID);
    // await updateTargets("cost", cost, type, organisationID);
    // await updateTargets("carbon", carbon, type, organisationID);
  }
